...
const HomeAdmin = () => {
    return (
        <Fragment>
                ...
                <div className="flex justify-between p-5">
                    ...
                    <div className="float-right">
                        <span className="flex flex-nowrap pt-5">
                            ...
                            <button className="text-1xl ml-5 text-white bg-purple-700 hover:bg-purple-800 focus:outline-none focus:ring-4 focus:ring-purple-300 font-medium rounded-full text-sm px-5 py-2.5 text-center mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900 ">logout</button>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div className="m-20 flex-initial w-full md:container md:mx-auto bg-[#e2e8f0] rounded-xl shadow-lg">
