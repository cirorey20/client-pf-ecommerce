...
import img from "../../../assets/logoUM.jpg";
          ...
          <View style={styles.section}>
            ...
            <View style={styles.paimentInfo}>
              <View style={styles.paimentInfoItem}>
                <Text>CLIENT</Text>
                <Text>{`${orderDetail.customer}`}</Text>
              </View>
              <View style={styles.paimentInfoItem}>
                <Text>EMAIL</Text>
              ...
              <View style={styles.paimentInfoItem}>
                ...
                <Text>{orderDetail.payment_method}</Text>
              </View>
              ...
              <br />
              <View style={styles.paimentInfoItem}>
                <Text>{orderDetail.address_order}</Text>
              </View>
            </View>
            ...
            <View style={styles.tableProducts}>
              ...
              {orderDetail.ProductOrders.map((p) => (
                <View key={p.id} style={styles.itemRow}>
                  ...
                  <View style={styles.columnBody10}>
                    <Text style={styles.bodyCell}>USD {p.price}</Text>
                  </View>
                  <View style={styles.columnBody10}>
                    <Text style={styles.bodyCell}>{`USD ${
                      p.quantity * p.price
                    }`}</Text>
                  </View>
                </View>
              ...
              <View style={styles.itemRow}>
                <View style={styles.columnFooterItems}>
                  <Text style={styles.footerCell}>
                    TOTAL ITEMS: {orderDetail.ProductOrders.length || "0"}
                  </Text>
                </View>
                <View style={styles.columnFooterTotal}>
                  <Text style={styles.footerCell}>
                    TOTAL PAID: USD{" "}
                    {orderDetail.ProductOrders?.reduce(
