...
<footer className="text-center text-black max-w-7xl mx-auto py-10 w-full mt-auto border-t">
  ...
  <div className="text-center text-gray-700 p-4 mx-8">
    © 2022 Copyright: 
    <a className="text-gray-800" href="https://tailwind-elements.com/">  UNIVERSAL MUSIC APP</a>
  </div>
...
//             <img src="https://flowbite.com/docs/images/logo.svg" className="mr-3 h-8" alt="Flowbite Logo"><img/>
...
{/* <footer className="footer p-10 bg-neutral text-neutral-content">
  <div>
    ...
    <p>Universal Music Ltda. Providing reliable with we clients </p>
  </div> 
  <div>
