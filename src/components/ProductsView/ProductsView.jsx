...
export default function ProductsView() {
  return (
    <div className="flex space-x-5 md:container md:mx-auto mb-24 h-[68vh] bg-[#fbfbfccb] shadow-gray-900">
      <div className="min-h-screen bg-[#e2e8f0]flex pt-20">
        <div className="border-2 w-70 h-min rounded-md cursor-pointer shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 duration-500">
          ...
          <div className=" bg-white">
            ...
            <h1 className="font-bold text-2xl">Bajos</h1>
          </div>
        </div>
      </div>
      <div className="min-h-screen bg-[#e2e8f0]flex pt-20">
        <div className="border-2 w-70 h-min rounded-md cursor-pointer shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 duration-500">
          ...
          <div className=" bg-white">
            ...
            <h1 className="font-bold text-2xl">Pianos</h1>
          </div>
        </div>
      </div>
      <div className="min-h-screen bg-[#e2e8f0]flex pt-20">
        <div className="border-2 w-70 h-min rounded-md cursor-pointer shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 duration-500">
          ...
          <div className=" bg-white">
            ...
            <h1 className="font-bold text-2xl">Baterias</h1>
          </div>
        </div>
      </div>
      <div className="min-h-screen bg-[#e2e8f0]flex pt-20">
        <div className="border-2 w-70 h-min rounded-md cursor-pointer shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 duration-500">
          ...
          <div className=" bg-white">
            ...
            <h1 className=" font-bold text-2xl">Guitarras</h1>
          </div>
        </div>
      </div>
    </div>
