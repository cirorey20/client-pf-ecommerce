    ...
    <div className="flex space-x-5 md:container md:mx-auto mb-24 h-[68vh] bg-[#fbfbfccb] shadow-gray-900">
      <Link to={"/home?categories=Cuerdas"}>
        <div className=" min-h-screen bg-[#e2e8f0]flex pt-8">
          <div className="pt-2 border-2 my-5 w-70 h-min rounded-md cursor-pointer shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 duration-500">
            <img
      ...
      <Link to={"/home?categories=Percusión"}>
        <div className="min-h-screen bg-[#e2e8f0]flex pt-8">
          <div className="pt-2 border-2 w-70 my-5 rounded-md cursor-pointer shadow-lg overflow-hidden hover:shadow-xl transform hover:scale-105 duration-500">
            <img
